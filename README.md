...
This is a simple project to integrate with a BME280 in a FreeRTOS environment.
...
```
git clone --recurse-submodules https://github.com/eremiticengineer/pico-bme280-test
```
